...
class TestRegistration:
    ...
    def test_successful_registration(self, page: Page, base_url: str):
        ...
        if current_url in [f"{base_url}/", f"{base_url}/login/"]:
            ...
            success_indicators = page.locator(
                ':has-text("success"), :has-text("created"), :has-text("registered"), .alert-success'
            )
    ...
    def test_password_mismatch_validation(self, page: Page, base_url: str):
        ...
        ), f"Form submission failed, unexpected URL: {current_url}"
    ...
    def test_navigation_to_login(self, page: Page, base_url: str):
        ...
        login_links = page.locator(
            'a[href*="login"], a:has-text("Sign in"), a:has-text("Login"), a:has-text("Already have")'
        )
